...
// MultiuserTcpServerUI.cpp: definiuje zachowania klasy dla aplikacji.
//
...
BEGIN_MESSAGE_MAP(CMultiuserTcpServerUIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Konstrukcja klasy CMultiuserTcpServerUIApp

CMultiuserTcpServerUIApp::CMultiuserTcpServerUIApp()
{
...
// Jedyny obiekt CMultiuserTcpServerUIApp

CMultiuserTcpServerUIApp theApp;


// Inicjowanie klasy CMultiuserTcpServerUIApp

BOOL CMultiuserTcpServerUIApp::InitInstance()
{
